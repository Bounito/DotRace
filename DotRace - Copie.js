...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function fctInitPlayers() {
        ...
        for (let i = 0; i < NbPlayers; i++) {
            ...
            html += '<br><span  class="classPlayerSpan" style="background-color:'+myColor+';"><b>'+myIaDepth+'</b>💡 ' + playersNames[i]+"</span>";
            if (i<rangeNbHuman.value) {
                html += ' 👨';
            }
            //========================================================
            ...
            divPlayer.style.backgroundColor = fctRbg2Rgba(myColor,.5);
            ...
            divFinishRankPlayer.style.width = '120px';
            divFinishRankPlayer.style.borderRadius = '10px';
            divFinishRankPlayer.innerHTML = playersNames[i];
            if (i<rangeNbHuman.value) {
        ...
        switch (gameMode) {
            ...
            case 'modeChamp':
                ...
                sortedPlayers.forEach(([playerId, playerData],index) => {
                    ...
                    divFinishRankNb.innerHTML = fctEmojiPodium(index+1) + ' <b>' + (index+1) + '</b> <small>' + rankChange + '</small>';
    ...
    function fctAffichageNext() {
        ...
        //console.log('prépa glisse',CurrentPlayer,tmpPos);
